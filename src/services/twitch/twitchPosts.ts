...
const postNewTwitchFollow = name => {
    return `Welcome to the team ${name}! Awesome to have you join us! KomodoHype teamta1RAWR #BeastieBot`;
};
...
const postEndOfStream = () => {
    return `Thanks for hanging out today team! :D Check our content release schedule for the next live stream, and don't forget to join the team Discord! https://discord.gg/eZtrhh7`;
};
